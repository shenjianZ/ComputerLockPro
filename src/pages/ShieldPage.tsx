    ...
    <>
      ...
      <section className="panel">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <p className="muted" style={{ fontSize: 12, margin: 0 }}>锁定期间键盘和鼠标输入将被禁用，到时自动恢复</p>
          <div className="form-inline">
            <strong>设备检测</strong>
          ...
          <p className="muted" style={{ fontSize: 12, margin: 0 }}>检测 USB Key 或蓝牙设备状态，用于解锁验证</p>
        </div>
      </section>
      ...
      <section className="panel">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <p className="muted" style={{ fontSize: 12, margin: 0 }}>终止指定进程，仅对正在运行的进程生效</p>
          <label className="form-inline">
            <strong>网站限制</strong>
          ...
          <p className="muted" style={{ fontSize: 12, margin: 0 }}>通过修改 hosts 文件屏蔽指定网站</p>
        </div>
      </section>
    </>
  );
